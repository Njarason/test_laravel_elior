...
<div class="d-flex justify-content-center">
    <form class="card p-3 bg-white shadow  w-50" action="{{ route('update-client', ['id' => $data['id']]) }}" method="post">

        @csrf
        <div class="w-100 my-1 d-flex justify-content-center">
        <label for="client"
                    class="client-text-title color-heading font-medium mb-2">Modifier un client</label>
        </div>
        <div class="row mb-25">
            <div class="col-md-6">
               <div>
               ...
               <div>
               <input id="client" type="text" name="client" value="{{ $data['client'] }}"
            ...
            <div class="col-md-6">
               ...
               <div>
               <select id="statut" type="text" name="statut" value="{{ $data['statut'] }}"
                    class="form-control">
            ...
            <div class="col-md-6">
               ...
               <div>
               <input id="whatsapp" type="text" name="whatsapp" value="{{ $data['whatsapp'] }}"
            ...
            <div class="col-md-6">
               ...
               <div>
               <input id="contact" type="text" name="contact" value="{{ $data['contact'] }}"
            ...
            <div class="col-md-6">
               <div>
                <label for="adresse"
                    class="label-text-title color-heading font-medium mb-2">Adresse</label>
               </div>
               <div>
               <input id="adresse" type="text" name="adresse" value="{{ $data['adresse'] }}"
